...
function wooc_extra_register_fields() {?>
       ...
       <input type="text" class="input-text" name="account_last_name" id="account_last_name" value="<?php if ( ! empty( $_POST['account_last_name'] ) ) esc_attr_e( $_POST['account_last_name'] ); ?>" />
       </p>
       <div class="clear"></div>
       <?php
 }
 ...
 function wooc_validate_extra_register_fields( $username, $email, $validation_errors ) {
      ...
      if ( isset( $_POST['account_first_name'] ) && empty( $_POST['account_first_name'] ) ) {
             ...
             $validation_errors->add( 'account_first_name_error', __( '<strong>Error</strong>: First name is required!', 'woocommerce' ) );

      }

      if ( isset( $_POST['account_last_name'] ) && empty( $_POST['account_last_name'] ) ) {

             $validation_errors->add( 'account_last_name_error', __( '<strong>Error</strong>: Last name is required!.', 'woocommerce' ) );
