<?php
        ...
        if (isset($settings['wpc_primary_color'])) {
            $bg_color = $settings['wpc_primary_color'] ? $settings['wpc_primary_color'] : "#e7272d ";
        ...
        // if cafe multi vendor not active add css
        $is_active = WpCafe\Core\Base\Config::instance()->init('Wpcafe_Multivendor');
        
        if ( false == $is_active['success'] ) {
            $wpc_custom_css .= '.wpc_cart_block .wpc_background_color a.button.wc-forward.checkout {  opacity: 0.5 } 
