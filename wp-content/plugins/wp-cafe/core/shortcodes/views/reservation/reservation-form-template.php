...
data-reservation_status='<?php echo json_encode( $booking_status ) ?>'>
    ...
    <div class='wpc_success_message' data-start="<?php echo esc_html__("Start time","wpcafe");?>" data-end="<?php echo esc_html__("End time","wpcafe");?>" data-schedule="<?php echo esc_html__("Schedule","wpcafe");?>" data-late_booking = "<?php echo ( $wpc_late_bookings !=="" ) ? esc_html__("You can book up until ".$wpc_late_bookings." minutes before closing time","wpcafe") : "" ?>"></div>
                ...
                <div class='<?php echo esc_attr($column_lg); ?>'>
                    <div class="wpc_reservation_form">
                        ...
                        <div class='wpc-select party wpc-reservation-field'>
                            <label for='wpc-total-guest'><?php echo esc_html__('Total Guests ', 'wpcafe'); ?><small class='wpc_required'>*</small></label>
