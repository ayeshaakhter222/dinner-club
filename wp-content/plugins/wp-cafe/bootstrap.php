...
final class Bootstrap{
    ...
    public function wpc_init_plugin() {
        ...
        if( file_exists( \Wpcafe::plugin_dir() . 'core/woocommerce/hooks.php' )){
            include_once \Wpcafe::plugin_dir() . 'core/woocommerce/hooks.php';
        }
    ...
    public function handle_buy_pro_menu(){
...

        {
            ...
            ->set_page_grid([
                'url' => 'https://www.facebook.com/groups/492321335116367',
            ...
            ->set_plugin_row_meta('Facebook Community','https://www.facebook.com/groups/492321335116367', ['target'=>'_blank'])
